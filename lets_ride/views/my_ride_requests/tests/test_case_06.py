...
TEST_CASE = {
    "request": {
        "path_params": {},
        "query_params": {"offset": 0, "limit": 3, "status": "", "sort_key": "date_time", "sort_value": "ASC"},
        "header_params": {},
...
class TestCase06MyRideRequestsAPITestCase(CustomTestUtils):
    app_name = APP_NAME
    ...
    def setupUser(self, username, password):
        ...
        user_id = user_obj.id
        self.ride_request_fixture_for_sort_by_datetime(user_id)
