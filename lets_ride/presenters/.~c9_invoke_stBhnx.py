...
class PresenterImplementation(PresenterInterface):
    ...
    def  get_asset_requests_response(
        ...
        for asset_request_dto in asset_request_dtos:
            asset_request_dict = self._get_asset_request_dict(asset_request_dto)
    ...
    def _get_asset_request_dict(self, asset_request_dto: AssetRequestDto):
        ...
        from_datetime_str = ""
        to_datetime_str = ""
        from_datetime_obj = base_asset_request_dto.flexible_from_date_time
        to_datetime_obj = base_asset_request_dto.flexible_to_date_time
        if base_asset_request_dto.flexible_timings:
            ...
            travel_datetime_obj = base_asset_request_dto.travel_date_time
            travel_date_time_str = self._get_datetime_in_string_format(
                travel_datetime_obj
            )
        asset_request_dict = {
            "asset_request_id": base_asset_request_dto.asset_request_id,
            "source": base_asset_request_dto.source,
            "destination": base_asset_request_dto.destination,
            "travel_date_time": travel_date_time_str,
            "flexible_timings": base_asset_request_dto.flexible_timings,
            "flexible_from_date_time": from_datetime_str,
            "flexible_to_date_time": to_datetime_str,
            "asset_quantity": base_asset_request_dto.asset_quantity,
            "asset_type": base_asset_request_dto.asset_type,
            "asset_type_others": base_asset_request_dto.asset_type_others,
            "asset_sensitivity": base_asset_request_dto.asset_sensitivity,
            "deliver_to": base_asset_request_dto.deliver_to,
            "phone_number": base_asset_request_dto.phone_number,
            "accepted_person" : asset_request_dto.accepted_person,
            "accepted_person_phone_number": \
                asset_request_dto.accepted_person_phone_number,
            "status": asset_request_dto.status
        }
