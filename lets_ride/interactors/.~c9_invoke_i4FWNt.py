...
class MatchingSharesResultsInteractor:
    ...
    def matching_share_results_wrapper(
        ...
        ride_asset_matching_dto = RideAssetMatchingDto(
            ...
            total_assets=total_matching_asset_requests
        )
    ...
    def _get_asset_request_matching_dtos_without_duplications(
        self,
        ride_matching_asset_dtos: List[AssetMatchingDto],
        travel_matching_asset_dtos: List[AssetMatchingDto]
    ) -> List[AssetMatchingDto]:

        asset_matching_dtos = []
        for ride_matching_asset_dto in ride_matching_asset_dtos:
            ride_matched_asset_id = \
                ride_matching_asset_dto.asset_dto.asset_request_id
            for travel_matching_asset_dto in travel_matching_asset_dtos:
                travel_matched_asset_id = \
                    travel_matching_asset_dto.asset_dto.asset_request_id
                if ride_matched_asset_id == travel_matched_asset_id:
                    continue
                asset_matching_dtos.append(ride_matching_asset_dto)

        asset_matching_dtos += travel_matching_asset_dtos
        return asset_matching_dtos
